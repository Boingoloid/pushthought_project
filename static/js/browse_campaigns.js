...
$(document).ready(function() {
    ...
    $('.campaigns-button').css('border-top','3px solid green');
    $('.campaigns-button').css('border-bottom','3px solid green');
    $('.campaigns-button').css('border-left','3px solid green');
    $('.campaigns-button').css('border-right','3px solid green');
